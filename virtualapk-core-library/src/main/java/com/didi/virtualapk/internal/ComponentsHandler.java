...
public class ComponentsHandler {
    ...
    private ArrayMap<Service, AtomicInteger> mServiceCounters
        = new ArrayMap<Service, AtomicInteger>();
    ...
    public Intent transformIntentToExplicitAsNeeded(Intent intent) {
        ...
        if (component == null
            ...
            if (info != null && info.activityInfo != null) {
                component = new ComponentName(info.activityInfo.packageName,
    ...
    private void dispatchStubActivity(Intent intent) {
        ...
        String stubActivity = mStubActivityInfo.getStubActivity(targetClassName, launchMode,
            themeObj);
