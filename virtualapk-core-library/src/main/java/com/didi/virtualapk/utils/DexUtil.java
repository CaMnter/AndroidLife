...
public class DexUtil {
    ...
    private static synchronized void insertNativeLibrary(DexClassLoader dexClassLoader)
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            nativeLibraryDirectories.add(
                Systems.getContext().getDir(Constants.NATIVE_DIR, Context.MODE_PRIVATE));
            ...
            Object newNativeLibraryPathElements = ReflectUtil.getField(newPathList.getClass(),
                newPathList, "nativeLibraryPathElements");
            ...
            Object allNativeLibraryPathElements = Array.newInstance(elementClass,
                baseArrayLength + 1);
            System.arraycopy(baseNativeLibraryPathElements, 0, allNativeLibraryPathElements, 0,
                baseArrayLength);
            ...
            ReflectUtil.setField(basePathList.getClass(), basePathList, "nativeLibraryPathElements",
                allNativeLibraryPathElements);
        } else {
            File[] nativeLibraryDirectories = (File[]) ReflectUtil.getFieldNoException(
                basePathList.getClass(),
                basePathList, "nativeLibraryDirectories");
            ...
            newNativeLibraryDirectories[N] = Systems.getContext()
                .getDir(Constants.NATIVE_DIR, Context.MODE_PRIVATE);
            ReflectUtil.setField(basePathList.getClass(), basePathList, "nativeLibraryDirectories",
