...
public class PluginUtil {
    ...
    public static void hookActivityResources(Activity activity, String packageName) {
        ...
        try {
            ...
            final LoadedPlugin plugin = PluginManager.getInstance(activity)
                .getLoadedPlugin(packageName);
            ...
            if (resources != null) {
                ...
                int themeResource = (int) ReflectUtil.getField(ContextThemeWrapper.class, activity,
                    "mThemeResource");
    ...
    public static void putBinder(Bundle bundle, String key, IBinder value) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ...
            try {
                ReflectUtil.invoke(Bundle.class, bundle, "putIBinder",
                    new Class[] { String.class, IBinder.class }, key, value);
            } catch (Exception e) {
            }
        }
    }
            ...
            while (e.hasMoreElements()) {
                ...
                if ((findSo && entry.getName().contains("lib/" + cpuArch)) ||
                    ...
                    File libFile = new File(
                        nativeLibDir.getAbsolutePath() + File.separator + libName);
