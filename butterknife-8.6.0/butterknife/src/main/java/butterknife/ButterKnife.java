...
public final class ButterKnife {
    ...
    /**
     * BindView annotated fields and methods in the specified {@link View}. The view and its
     * children
    ...
    /**
     * BindView annotated fields and methods in the specified {@code target} using the {@code
     * source}
    ...
    /**
     * Apply the specified {@code value} across the {@code array} of views using the {@code
     * property}.
     */
    @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) // http://b.android.com/213630
    @RequiresApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
