...
public class BindViewsTest {
    ...
    public void bindingGeneratedView() {
        ...
        assertAbout(javaSources()).that(
            ImmutableList.of(source, TestGeneratingProcessor.ANNOTATION))
            .processedWith(new ButterKnifeProcessor())
            .failsToCompile()
        ...
        assertAbout(javaSources()).that(
            ...
            .compilesWithoutError()
            .withNoteContaining("@BindViews List or array with unresolved type (GeneratedView)")
            .and()
            .withNoteContaining("must elsewhere be generated as a View or interface")
            .and()
            .and()
