...
public final class ApkUtils {
    ...
    public static Map<ComponentName, ActivityInfo> getActivityInfos(@NonNull final File apkFile,
     ...
     */
    @SuppressLint("PrivateApi")
    public Map<ComponentName, ServiceInfo> getServiceInfos(@NonNull final File apkFile,
                                                           @NonNull final Context context)
        throws Exception {
    ...
    public static Map<ActivityInfo, List<? extends IntentFilter>> getReceiverInfos(@NonNull final File apkFile,
        ...
        if (sdkVersion >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
             ...
             */
            final Field receiversField = packageObject.getClass().getDeclaredField("receivers");
            final List receivers = (List) receiversField.get(packageObject);
