...
public class PatchRefScan {
     ...
     */
    public static void addClassIfRefPatchClass(JarEntry jarEntry, String className, Set<String> allref, Set<String> patchClasses, JarFile alljar, File patchDir)
        throws Exception {
    ...
    public static void addClasstoPatch(JarEntry jarEntry, String className, JarFile alljar, File patchDir)
        throws Exception {
