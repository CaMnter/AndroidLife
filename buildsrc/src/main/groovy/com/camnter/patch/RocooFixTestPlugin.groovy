...
class RocooFixTestPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        println(ReflectionToStringBuilder.toString(variants,
                RecursiveToStringStyle.MULTI_LINE_STYLE));
        def plugin = project.plugins.findPlugin(AppPlugin.class);
        println(ReflectionToStringBuilder.toString(plugin,
                RecursiveToStringStyle.MULTI_LINE_STYLE));
        println(ReflectionToStringBuilder.toString(plugin.extension,
                RecursiveToStringStyle.MULTI_LINE_STYLE))
        ...
        variants.all { variant ->
            ...
            manager.transforms.each {
                println(ReflectionToStringBuilder.toString(it,
                        RecursiveToStringStyle.MULTI_LINE_STYLE));
            }
            ...
            if (proguardTransform) {
                println(ReflectionToStringBuilder.toString(proguardTransform.configuration,
                        RecursiveToStringStyle.MULTI_LINE_STYLE))
            };
        }
        println("==================variant end====================")
