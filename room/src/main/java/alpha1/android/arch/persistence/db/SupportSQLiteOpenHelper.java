...
package alpha1.android.arch.persistence.db;
...
public interface SupportSQLiteOpenHelper {
     ...
     */
    @SuppressWarnings("WeakerAccess") class Configuration {
        /**
        ...
        public static class Builder {
             ...
             * {@link SupportSQLiteOpenHelper.Callback#onUpgrade(SupportSQLiteDatabase, int, int)}
             * will be used to upgrade the database; if the database is newer,
             * {@link SupportSQLiteOpenHelper.Callback#onDowngrade(SupportSQLiteDatabase, int,
             * int)}
             * will be used to downgrade the database.
             * @return this
             */
