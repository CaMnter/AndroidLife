                    ...
                    public void run() {
                        try {
                            ...
                            final SmartApplication smartApplication
                                = (SmartApplication) LoadServicePluginHostActivity.this.getApplication();
                            final Intent intent = new Intent(LoadServicePluginHostActivity.this,
                                smartApplication
                                    .getDexClassLoader()
                                    .loadClass(
                                        "com.camnter.load.service.plugin.plugin.PluginService"));
                            startActivity(intent);
                        } catch (Exception e) {
                            ToastUtils.show(LoadServicePluginHostActivity.this, e.getMessage(),
                                Toast.LENGTH_LONG);
                            e.printStackTrace();
                        } finally {
