...
JNIEXPORT void JNICALL Java_com_camnter_newlife_ui_activity_classloader_NativeBlurProcess_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
