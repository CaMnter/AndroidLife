...
public class AnimatorActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private void initAnimator() {
        ...
        this.rotationAnimator = ObjectAnimator.ofFloat(this.rotationTv, "rotation", 0f, 180f, 0f, 180f, 0f);
        ...
        this.scaleAnimator = ObjectAnimator.ofFloat(this.scaleTv, "scaleY", 1f, 1.5f, 1f, 1.5f, 1f, 1.5f, 1f, 1.5f, 1f);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.animator_translation_tv: {
                ...
                this.translationAnimator = ObjectAnimator.ofFloat(this.translationTv, "translationY", tY, -totalHeight, tY, -totalHeight, tY);
            ...
            case R.id.animator_set_tv: {
                ...
                ObjectAnimator alpha = ObjectAnimator.ofFloat(this.setTv, "alpha", 1f, 0f, 1f, 0f, 1f);
                ObjectAnimator scale = ObjectAnimator.ofFloat(this.setTv, "scaleY", 1f, 1.5f, 1f, 1.5f, 1f, 1.5f, 1f, 1.5f, 1f);
