package com.camnter.newlife.view.fragment.tablayoutfragment;
 ...
 */
public class TabLayoutSecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (this.self == null) {
            this.self = inflater.inflate(R.layout.tablayout_second_fragment, null);
        }
