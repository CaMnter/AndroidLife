...
package com.camnter.newlife.utils.react.bridge;

import javax.annotation.Nullable;

/**
 * Utility class to make assertions that should not hard-crash the app but instead be handled by
 * the
...
public class SoftAssertions {
     ...
     * {@code if} block with assert condition in case you plan to do string concatenation to
     * produce
     * the message.
     */
