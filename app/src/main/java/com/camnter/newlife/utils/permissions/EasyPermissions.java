...
public class EasyPermissions {
    ...
    /**
     * Find all methods annotated with {@link  AfterPermissionGranted} on
     * a given object with the
        ...
        while (clazz != null) {
            for (Method method : clazz.getDeclaredMethods()) {
                if (method.isAnnotationPresent(
                    AfterPermissionGranted.class)) {
                    // Check for annotated methods with matching request code.
                    AfterPermissionGranted ann = method.getAnnotation(
                        AfterPermissionGranted.class);
