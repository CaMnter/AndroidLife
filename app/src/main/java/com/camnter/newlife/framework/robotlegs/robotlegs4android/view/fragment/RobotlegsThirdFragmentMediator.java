...
public class RobotlegsThirdFragmentMediator extends Mediator {
    ...
    private void initViews() {
        ...
        resIds.add(R.drawable.img_mm_8);
        resIds.add(R.drawable.img_mm_9);
        resIds.add(R.drawable.img_mm_10);
        resIds.add(R.drawable.img_mm_11);
        resIds.add(R.drawable.img_mm_12);
        resIds.add(R.drawable.img_mm_13);
        resIds.add(R.drawable.img_mm_14);
        resIds.add(R.drawable.img_mm_15);
        resIds.add(R.drawable.img_mm_16);
        resIds.add(R.drawable.img_mm_17);
        resIds.add(R.drawable.img_mm_18);
        resIds.add(R.drawable.img_mm_19);
        resIds.add(R.drawable.img_mm_20);
