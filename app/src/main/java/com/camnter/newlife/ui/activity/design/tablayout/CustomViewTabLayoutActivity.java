package com.camnter.newlife.ui.activity.design.tablayout;
...
import com.camnter.newlife.ui.fragment.tablayoutfragment.TabLayoutThirdFragment;
...
public class CustomViewTabLayoutActivity extends BaseAppCompatActivity {
    ...
    @Override protected void initData() {
        int[] icons = { R.drawable.ic_clean, R.drawable.ic_remark, R.drawable.ic_time,
