package com.camnter.newlife.ui.activity.lrucache;
...
@TargetApi(Build.VERSION_CODES.HONEYCOMB_MR1) public class LruCacheActivity
    ...
    @BindView(R.id.camnter_size_text) TextView mCamnterSizeText;
    @BindView(R.id.camnter_count_text) TextView mCamnterCountText;
    @BindView(R.id.drakeet_size_text) TextView mDrakeetSizeText;
    @BindView(R.id.drakeet_count_text) TextView mDrakeetCountText;
    @BindView(R.id.ka_size_text) TextView mKaSizeText;
    @BindView(R.id.ka_count_text) TextView mKaCountText;
    @BindView(R.id.peter_size_text) TextView mPeterSizeText;
    @BindView(R.id.entryRemoved_info_text) TextView mEntryRemovedInfoText;
    @BindView(R.id.get_one) Button mGetOne;
    @BindView(R.id.get_two) Button mGetTwo;
    @BindView(R.id.get_three) Button mGetThree;
    @BindView(R.id.clear_remove_info) Button mClearRemoveInfo;
    @BindView(R.id.put_four) Button mPutFour;
    @BindView(R.id.camnter_hashCode_text) TextView mCamnterHashCodeText;
    @BindView(R.id.drakeet_hashCode_text) TextView mDrakeetHashCodeText;
    @BindView(R.id.ka_hashCode_text) TextView mKaHashCodeText;
    @BindView(R.id.peter_hashCode_text) TextView mPeterHashCodeText;
    @BindView(R.id.recent_info_text) TextView mRecentInfoText;
    @BindView(R.id.cache_data_text) TextView mCacheDataText;
